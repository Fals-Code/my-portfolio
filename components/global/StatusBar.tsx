...
import AudioStatus from "@/components/ui/AudioStatus";

export default function StatusBar() {
  return (
    <div className="fixed bottom-0 left-0 w-full bg-[var(--bg)]/90 backdrop-blur-md border-t border-[var(--border)] z-50 px-4 py-3 sm:py-2 flex items-center justify-between text-[0.65rem] sm:text-xs font-mono text-[var(--muted)] pb-[max(12px,env(safe-area-inset-bottom))]">
      <div className="flex items-center gap-3 sm:gap-6 overflow-x-auto whitespace-nowrap hide-scrollbar flex-1">
        ...
        <div className="hidden lg:block w-px h-3 bg-[var(--border)]" />
