...
export default function MobileGating() {
  return (
    <div className="fixed inset-0 z-[200] bg-[var(--bg)] flex items-center justify-center p-6 text-center overflow-hidden">
      {/* Background patterns */}
      ...
      >
        <div className="relative inline-block">
          ...
          <motion.div 
            ...
            className="absolute -top-1 -right-1 w-6 h-6 bg-red-500 rounded-full border-4 border-[var(--bg)] flex items-center justify-center"
          >
        ...
        <div className="space-y-4">
          <h1 className="text-4xl font-syne font-black text-[var(--text)] italic tracking-tighter">
            DESKTOP <span className="text-[var(--accent)]">REQUIRED</span>
          </h1>
        ...
        <div className="p-6 rounded-3xl bg-[var(--bg-card)] border border-[var(--border)] flex items-start gap-4 text-left">
            <Laptop className="w-6 h-6 text-[var(--post)] shrink-0 mt-1" />
